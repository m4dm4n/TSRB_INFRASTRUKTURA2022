...
#Restore GPT_TABLES
sgdisk -l $shareDir/share/GPTTablice/RacTablice/pc02All_Partitions.gpt /dev/nvme0n1
sgdisk -l $shareDir/share/GPTTablice/RacTablice/pc0304All_Data_Partitions.gpt /dev/sda
partprobe
